...
const Home = ({ navigation }) => {
	...
	const filterArray = [
		{ source: require('../../assets/open-compressed.jpg'), name: 'Open', filter: 'open' },
	...
	return (
		<KeyboardAwareScrollView
			...
			<Image
				source={require('../../assets/header-compressed.jpg')}
			...
			<View style={styles.greetingview}>
				...
				<Text style={{ textAlign: 'center', fontSize: 16.5, fontFamily: 'NewYorkSmall-Regular' }}>
					{tagline}
				</Text>
			</View>
					...
					return (
						<View
							...
							<TouchableOpacity
								...
								<Comp source={item.source} name={item.name} />
							</TouchableOpacity>
						</View>
					);
				}}
				...
				ListEmptyComponent={
					<Text
						style={{
							...
							paddingLeft: 15,
							paddingRight: 15,
							fontFamily: 'NewYorkSmall-RegularItalic',
						}}>
						{nodata}
					</Text>
				}
