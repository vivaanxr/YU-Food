  ...
  firebase.auth().onAuthStateChanged(function(user) {
    if (user) {
      ...
      async function SetName(){
        const res = await Ref.update({fullName: Name});
        RNRestart.Restart();
      }
        SetName();
    } 
...
return(
  ...
  <View style={styles.headerview}>
    <Text style={{fontSize:30,marginTop:"40%",fontFamily:"AzoSans-Medium",alignSelf:'center',marginBottom:"10%"}}>Change Name</Text>
    <TextInput
        style={styles.input}
    ...
    <TouchableOpacity style={styles.touchable} onPress={()=> ChangeName()}>
