		...
		<KeyboardAwareScrollView>
			...
			<View style={styles.greetingview}>
				<Text style={styles.Time}>
					Monday: {item.M}-{item.MC}
				</Text>
				<Text style={styles.Time}>
					Tuesday: {item.T}-{item.TC}
				</Text>
				<Text style={styles.Time}>
					Wednesday: {item.W}-{item.WC}
				</Text>
				<Text style={styles.Time}>
					Thursday: {item.TH}-{item.THC}
				</Text>
				<Text style={styles.Time}>
					Friday: {item.F}-{item.FC}
				</Text>
				<Text style={styles.Time}>
					Saturday: {item.SA}-{item.SAC}
				</Text>
				<Text style={styles.Time}>
					Sunday: {item.SU}-{item.SUC}
				</Text>
			</View>
		</KeyboardAwareScrollView>
	);
