...
const comp = ({source,name}) => {
    return (
    <View style={{height:158,width:(Dimensions.get('screen').width-10) / 3,resizeMode:"contain"}}>
    <Image style={{resizeMode:"contain",height:130, width: (Dimensions.get('screen').width-15) / 3,backgroundColor:"#fafafa"}} source={source}/>
