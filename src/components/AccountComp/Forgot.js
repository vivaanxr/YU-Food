    ...
    <TouchableOpacity onPress={()=>navigation.navigate("Forgot",{Next:"AccountSettings"})}>
      ...
      <View style={{flexDirection:'row',flex:1,justifyContent:"space-between"}}>
          <View style={{flexDirection:'row'}}>
            <Image source={require('../../../assets/f.png')} style={{width: 25, height: 25,marginTop: 20,marginLeft:2}} />
            <Text style={{fontSize:18,lineHeight:63,fontFamily:"NewYorkSmall-Regular"}}> {"\ "}Forgot Password</Text>
          </View>
